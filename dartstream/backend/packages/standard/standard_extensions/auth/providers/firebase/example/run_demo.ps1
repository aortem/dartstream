#!/usr/bin/env pwsh
# Firebase Auth Demo - Unified Launcher
# This script starts the backend server which also serves the frontend

Write-Host "🚀 Firebase Authentication Demo Launcher" -ForegroundColor Cyan
...
Write-Host "🔥 Starting Firebase Auth Demo Server..." -ForegroundColor Yellow
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "💡 The server will start on http://localhost:8080" -ForegroundColor White
