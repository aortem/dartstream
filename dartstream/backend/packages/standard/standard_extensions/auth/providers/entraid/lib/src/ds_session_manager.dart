...
class DSSessionManager {
  static const String _sessionDir = '.ds_entraid_sessions';
  static const String _sessionFile = 'entraid_session.json';
  ...
  Future<void> refreshSession(String userId) async {
    try {
      ...
      if (sessionData != null) {
        ...
        print('Entraid session refreshed for user: $userId');
      }
    } catch (e) {
