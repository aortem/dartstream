  ...
  group('Download Handler', () {
    ...
    test('downloads a valid file', () async {
      final request = Request(
        'GET',
        Uri.parse('http://localhost/download/test.txt'),
      );
      ...
      expect(
        ...
        contains('attachment; filename="test.txt"'),
      );
    ...
    test('returns 404 for missing file', () async {
      final request = Request(
        'GET',
        Uri.parse('http://localhost/download/missing.txt'),
      );
      final response = await handler(request);
    ...
    test('returns 403 for path traversal attempt', () async {
      ...
      try {
        ...
        final request = Request(
          'GET',
          Uri.parse('http://localhost/download/anything'),
          context: {
