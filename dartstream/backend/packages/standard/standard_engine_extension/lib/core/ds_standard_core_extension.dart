...
class DSStandardCoreExtensions extends DSStandardCore {
  ...
  void debug() {
    print("Debugging Dartstream Standard Core Extensions:");
  ...
  Future<void> initializeComponents() async {
    ...
    await _initializeMetering();
  }

  Future<void> _initializeTenancy() async {
    registerService("tenant_resolver", TenantResolver());
  }

  Future<void> _initializeBilling() async {
    registerThirdPartyEnhancement(
      "billing",
      BillingService(),
    );
  }
