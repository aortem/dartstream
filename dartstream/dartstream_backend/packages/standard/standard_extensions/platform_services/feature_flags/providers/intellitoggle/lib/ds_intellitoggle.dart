...
/// GoFeatureFlagProvider integrates with the Go Feature Flag service.
...
class GoFeatureFlagProvider implements DSFeatureFlagProvider {
  ...
  /// [apiUrl]: The base URL for the Go Feature Flag API.
  ...
  Future<bool> getBooleanFlag(String flagKey,
      {bool defaultValue = false, Map<String, dynamic>? context}) async {
  ...
  Future<String> getStringFlag(String flagKey,
      {String defaultValue = '', Map<String, dynamic>? context}) async {
    final result = await evaluateFlag(flagKey, context: context);
  ...
  Future<num> getNumberFlag(String flagKey,
      {num defaultValue = 0, Map<String, dynamic>? context}) async {
    final result = await evaluateFlag(flagKey, context: context);
  ...
  @override
  Future<DSFeatureFlagEvaluationResult> evaluateFlag(String flagKey,
      {Map<String, dynamic>? context}) async {
    try {
