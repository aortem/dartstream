  ...
  <transition name="fade">
    ...
    >
        ...
        >
          ...
          >
            <h2 class="text-lg">Connect new Application sdk</h2>
 ...
 <form class="mt-2 space-y-6">
          <div class="p-4 m-4 space-y-4 border border-gray rounded-[16px]">
            <div class="flex gap-3">
              ...
              <div class="">
                <label class="block font-medium text-black">SDKs</label>
                <p class="text-xs text-gray-500">Enter SDK details</p>
              </div>
            </div>
            <div class="">
            ...
            <div>
              <label class="block font-medium">Enviroment</label>
              <select
