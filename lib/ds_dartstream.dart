...
class DsDartstream {
  ...
  Future<void> connectToPostgreSQL(String host, int port, String dbName,
  ...
  Future<void> connectToGcpCloudAuthProxy(
      String proxyUrl, String targetUrl) async {
    // Make an HTTP request through the Cloud Auth Proxy
    final response =
        await _httpClient.get(Uri.parse('$proxyUrl/v1/$targetUrl'));
