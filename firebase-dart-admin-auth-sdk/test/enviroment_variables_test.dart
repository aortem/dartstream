...
void main() {
  ...
  test('signInWithEmailAndPassword fails', () async {
    ...
    expect(
      () =>
          auth?.signInWithEmailAndPassword('test@example.com', 'wrongpassword'),
  ...
  test('should apply action code if FirebaseApp is initialized', () async {
    when(() => mockClient.post(any(),
      ...
      (_) async => http.Response(
          '{ "email": "user@example.com","requestType": "VERIFY_EMAIL"}', 200),
    );
  ...
  final List<Map<String, dynamic>> methods = [
    {
      'description': 'enviroment_variables',
      'method': () => FirebaseApp.initializeAppWithEnvironmentVariables(
            apiKey: 'adasdasdasda',
